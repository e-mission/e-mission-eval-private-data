...
def get_mixed_variance_covariance_term_for_nonlinear_variance_propagation(x,y):
    ...
    # the terms generated by this were added in to the variance like so. I think it was an incorrect approach.
    #var_term_1 = var_EI*mean_L[s]**2 + var_L[s]*mean_EI**2 + 2*EI_length_covariance*mean_EI*mean_L[s]  # s is a section
